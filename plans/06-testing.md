...
```bash
# Run all tests
pnpm --filter template-agnostic-server-app test

# Run specific test file
pnpm --filter template-agnostic-server-app test test/mempool/decoder.test.ts

# Run with coverage
pnpm --filter template-agnostic-server-app test -- --coverage
```
